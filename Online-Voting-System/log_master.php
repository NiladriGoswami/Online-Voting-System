...
if(isset($_POST['submit']))
{
	...
	$sql = "select * from member where email='$uname'";
	//echo $sql;
...
<form id="form1" name="form1" method="post" action="">
  <table width="100%" border="0" bgcolor="#F7F7F4">
    <tr>
      <td><table width="100%" height="599" border="0">
    <tr>
      ...
      <td width="64%" align="center"><table width="100%"  cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td height="167" align="center"><table width="60%" border="0" cellspacing="0" cellpadding="0" class="bod">
              <tr>
                <td width="32%" height="132" align="right"><img src="images/keylock.png" width="100" height="120" /></td>
        ...
        <tr>
          <td align="center"> Not yet registered ? <a href="registration_master.php"><strong>Register Here</strong></a></td>
        </tr>
      </table></td>
      <td width="20%"></td>
    </tr>
